...
public class OBJLoader {
    ...
    private static void processFaceVertex(IdxGroup indices, List<Vector2f> textCoordList,
        ...
        if (indices.idxTexCoord >= 0 && textCoordList.size() > 0) {
            Vector2f textCoord = textCoordList.get(indices.idxTexCoord);
            texCoordArr[posIndex * 2] = textCoord.x;
            texCoordArr[posIndex * 2 + 1] = 1 - textCoord.y;
        }
        if (indices.idxNormal >= 0) {
            // Reorder vectornormals
            Vector3f vecNorm = normList.get(indices.idxNormal);
    ...
    protected static class Face {
        ...
        private IdxGroup parseLine(String line) {
            ...
            if (length > 1) {
                ...
                if (length > 2) {
                    idxGroup.idxNormal = Integer.parseInt(lineTokens[2]) - 1;
                }
            }
